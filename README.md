...
Template code for [Project 3 (Path Planning)](https://hellorob.org/projects/p3) in Python. See project instructions for more details.
...
This repository includes a helper script to visualize plan outputs compatible with the [navigation web app](https://hellorob.org/nav-app/). A tutorial is available [here](https://hellorob.org/tutorials/app). You can run this file on your laptop (as long as you have Python 3 installed). To do so, do:
